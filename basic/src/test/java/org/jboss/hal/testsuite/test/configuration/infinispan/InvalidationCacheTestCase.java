...
public class InvalidationCacheTestCase extends AbstractCacheTestCase {
    ...
    public static void beforeClass_() {
        initializeTBAAddress(CacheType.INVALIDATION);
    }
    ...
    protected Address createCache() throws IOException, TimeoutException, InterruptedException {
        final Address address = ABSTRACT_CACHE_ADDRESS.and(CacheType.INVALIDATION.getAddressName(), RandomStringUtils.randomAlphabetic(7));
