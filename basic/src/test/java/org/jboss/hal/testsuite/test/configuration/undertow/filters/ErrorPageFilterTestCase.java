...
public class ErrorPageFilterTestCase {
    ...
    private static final String
            CODE = "code",
            PATH = "path",
            FILTER_NAME = "error-page_" + RandomStringUtils.randomAlphanumeric(5),
            FILTER_TBA_NAME = "error-page_TBA_" + RandomStringUtils.randomAlphanumeric(5),
            FILTER_TBR_NAME = "error-page_TBR_" + RandomStringUtils.randomAlphanumeric(5);
    ...
    private static final Address
            ...
            FILTER_ADDRESS = FILTERS_ADDRESS.and("error-page", FILTER_NAME),
            FILTER_TBA_ADDRESS = FILTERS_ADDRESS.and("error-page", FILTER_TBA_NAME),
            FILTER_TBR_ADDRESS = FILTERS_ADDRESS.and("error-page", FILTER_TBR_NAME);
    ...
    public static void beforeClass() throws IOException {
        operations.add(FILTER_TBR_ADDRESS, Values.of(CODE, 404)).assertSuccess();

        operations.add(FILTER_ADDRESS, Values.of(CODE, 404)).assertSuccess();
    }

    @Before
    public void before() {
        page.navigate();
        page.selectFilterType("Error Page");
    ...
    public void editCode() throws Exception {
        ...
        new ConfigChecker.Builder(client, FILTER_ADDRESS)
                ...
                .editAndSave(ConfigChecker.InputType.TEXT, CODE, String.valueOf(value))
                .verifyFormSaved()
                .verifyAttribute(CODE, value);
    }
