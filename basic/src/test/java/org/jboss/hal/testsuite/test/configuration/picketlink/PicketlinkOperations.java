...
/**
 * Abstraction for CLI operations related to PicketLink extension itself like enable or disable extension.
 */
public class PicketlinkOperations {
    ...
    public void disableExtension() throws IOException, InterruptedException, TimeoutException {
