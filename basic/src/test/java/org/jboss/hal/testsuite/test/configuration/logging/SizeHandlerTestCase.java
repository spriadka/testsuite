...
public class SizeHandlerTestCase extends LoggingAbstractTestCase {
    ...
    public void updateSizeHandlerNamedFormatter() throws Exception {
        ...
        final ModelNodeResult
                formatterModelNodeResult = operations.readAttribute(SIZE_HANDLER_ADDRESS, FORMATTER),
                namedFormatterModelNodeResult = operations.readAttribute(SIZE_HANDLER_ADDRESS, NAMED_FORMATTER);
        ...
        try {
            ...
            operations.batch(new Batch()
                    .writeAttribute(SIZE_HANDLER_ADDRESS, FORMATTER, formatterModelNodeResult.value())
                    .writeAttribute(SIZE_HANDLER_ADDRESS, NAMED_FORMATTER, namedFormatterModelNodeResult.value()))
                    .assertSuccess();
            administration.reloadIfRequired();
        }
    }
