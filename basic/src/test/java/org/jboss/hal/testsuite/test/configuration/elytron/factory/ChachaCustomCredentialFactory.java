 ...
 */
public class ChachaCustomCredentialFactory implements CredentialSecurityFactory {

    private static final String CHACHA = "Chacha";

    @Override
    public Credential create() throws GeneralSecurityException {
        return new BearerTokenCredential(CHACHA);
    }
