...
public class ExpressionFilterTestCase {
    ...
    private static final String
            ...
            MODULE = "module",
            FILTER_NAME = "expression-filter_" + RandomStringUtils.randomAlphanumeric(5),
            FILTER_TBA_NAME = "expression-filter_TBA_" + RandomStringUtils.randomAlphanumeric(5),
            FILTER_TBR_NAME = "expression-filter_TBR_" + RandomStringUtils.randomAlphanumeric(5);
    ...
    private static final Address
            ...
            FILTER_ADDRESS = FILTERS_ADDRESS.and("expression-filter", FILTER_NAME),
            FILTER_TBA_ADDRESS = FILTERS_ADDRESS.and("expression-filter", FILTER_TBA_NAME),
            FILTER_TBR_ADDRESS = FILTERS_ADDRESS.and("expression-filter", FILTER_TBR_NAME);
    ...
    public static void beforeClass() throws IOException {
        operations.add(FILTER_TBR_ADDRESS, Values.of(EXPRESSION, "quz")).assertSuccess();

        operations.add(FILTER_ADDRESS, Values.of(EXPRESSION, "quz")).assertSuccess();
    }

    @Before
    public void before() {
        page.navigate();
        page.selectFilterType("Expression");
    ...
    public void testAddingFilter() throws Exception {
        ...
        editor.text(EXPRESSION, RandomStringUtils.randomAlphanumeric(7));
    ...
    public void editExpression() throws Exception {
        ...
        new ConfigChecker.Builder(client, FILTER_ADDRESS)
                ...
                .editAndSave(ConfigChecker.InputType.TEXT, EXPRESSION, value)
                .verifyFormSaved()
                .verifyAttribute(EXPRESSION, value);
    }
