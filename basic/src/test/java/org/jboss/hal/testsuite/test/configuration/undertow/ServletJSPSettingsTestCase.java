...
public class ServletJSPSettingsTestCase extends UndertowTestCaseAbstract {
    ...
    @Test
    public void setDisabledToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, DISABLED, DISABLED_ATTR, true);
    }

    @Test
    public void setDisabledToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, DISABLED, DISABLED_ATTR, false);
    }

    @Test
    public void setDumpSmapToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, DUMP_SMAP, DUMP_SMAP_ATTR, true);
    }

    @Test
    public void setDumpSmapToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, DUMP_SMAP, DUMP_SMAP_ATTR, false);
    }

    @Test
    public void setGenerateStringsAsCharArraysToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, GENERATE_STRINGS_AS_CHAR_ARRAYS, GENERATE_STRINGS_AS_CHAR_ARRAYS_ATTR, true);
    }

    @Test
    public void setGenerateStringsAsCharArraysToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, GENERATE_STRINGS_AS_CHAR_ARRAYS, GENERATE_STRINGS_AS_CHAR_ARRAYS_ATTR, false);
    }

    @Test
    public void setJavaEncoding() throws IOException, InterruptedException {
        editTextAndVerify(address, JAVA_ENCODING, JAVA_ENCODING_ATTR);
    }

    @Test
    public void setMappedFileToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, MAPPED_FILE, MAPPED_FILE_ATTR, true);
    }

    @Test
    public void setMappedFileToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, MAPPED_FILE, MAPPED_FILE_ATTR, false);
    }

    @Test
    public void editScratchDir() throws IOException, InterruptedException {
        editTextAndVerify(address, SCRATCH_DIR, SCRATCH_DIR_ATTR);
    }

    @Test
    public void setSmapToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, SMAP, SMAP_ATTR, true);
    }

    @Test
    public void setSmapToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, SMAP, SMAP_ATTR, false);
    }

    @Test
    public void editSourceVM() throws IOException, InterruptedException {
        editTextAndVerify(address, SOURCE_VM, SOURCE_VM_ATTR);
    }

    @Test
    public void setTagPoolingToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, TAG_POOLING, TAG_POOLING_ATTR, true);
    }

    @Test
    public void setTagPoolingToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, TAG_POOLING, TAG_POOLING_ATTR, false);
    }

    @Test
    public void editTargetVM() throws IOException, InterruptedException {
        editTextAndVerify(address, TARGET_VM, TARGET_VM_ATTR);
    }

    @Test
    public void setTrimSpacesToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, TRIM_SPACES, TRIM_SPACES_ATTR, true);
    }

    @Test
    public void setTrimSpacesToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, TRIM_SPACES, TRIM_SPACES_ATTR, false);
    }

    @Test
    public void setXPoweredByToTrue() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, X_POWERED_BY, X_POWERED_BY_ATTR, true);
    }

    @Test
    public void setXPoweredByToFalse() throws IOException, InterruptedException {
        editCheckboxAndVerify(address, X_POWERED_BY, X_POWERED_BY_ATTR, false);
    }

    @Test
    public void setDevelopmentToTrue() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, DEVELOPMENT, DEVELOPMENT_ATTR, true);
    }

    @Test
    public void setDevelopmentToFalse() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, DEVELOPMENT, DEVELOPMENT_ATTR, false);
    }

    @Test
    public void setKeepGeneratedToTrue() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, KEEP_GENERATED, KEEP_GENERATED_ATTR, true);
    }

    @Test
    public void setKeepGeneratedToFalse() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, KEEP_GENERATED, KEEP_GENERATED_ATTR, false);
    }

    @Test
    public void editModificationTestInterval() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editTextAndVerify(address, MODIFICATION_TEST_INTERVAL, MODIFICATION_TEST_INTERVAL_ATTR, NUMERIC_VALID);
    }

    @Test
    public void editModificationTestIntervalInvalid() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        verifyIfErrorAppears(MODIFICATION_TEST_INTERVAL, NUMERIC_INVALID);
    }

    @Test
    public void setRecompileOnFailToTrue() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, RECOMPILE_ON_FAIL, RECOMPILE_ON_FAIL_ATTR, true);
    }

    @Test
    public void setRecompileOnFailToFalse() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, RECOMPILE_ON_FAIL, RECOMPILE_ON_FAIL_ATTR, false);
    }

    @Test
    public void setErrorOnUseBeanInvalidToTrue() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
    ...
    @Test
    public void setErrorOnUseBeanInvalidToFalse() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
    ...
    @Test
    public void setDisplaySourceFragmentToTrue() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, DISPLAY_SOURCE_FRAGMENT, DISPLAY_SOURCE_FRAGMENT_ATTR, true);
    }

    @Test
    public void setDisplaySourceFragmentToFalse() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editCheckboxAndVerify(address, DISPLAY_SOURCE_FRAGMENT, DISPLAY_SOURCE_FRAGMENT_ATTR, false);
    }

    @Test
    public void editCheckInterval() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
        editTextAndVerify(address, CHECK_INTERVAL, CHECK_INTERVAL_ATTR, NUMERIC_VALID);
    }

    @Test
    public void editCheckIntervalInvalid() throws IOException, InterruptedException {
        page.switchToJSPDevelopment();
