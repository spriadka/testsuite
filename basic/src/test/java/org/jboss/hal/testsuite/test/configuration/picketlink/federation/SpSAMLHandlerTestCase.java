...
import org.jboss.hal.testsuite.test.configuration.picketlink.federation.UtilFedName.Key;
...
public class SpSAMLHandlerTestCase extends AbstractFederationTestCase {
    ...
    public void before() throws IOException, OperationException {
        ...
        page.navigateToServiceProvider(federationName, spName).switchSubTab(SAML_HANDLERS_LABEL);
    }
    ...
    public void removeHandler() throws Exception {
        federationOps.addSpSAMLHandler(federationName, spName, handlerName, className);
        page.navigateToServiceProvider(federationName, spName).switchSubTab(SAML_HANDLERS_LABEL);
